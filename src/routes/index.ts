...
router.use('/api/v1/restaurants/:restaurantId/categories', ...authMiddleware, categoryRoutes);
router.use('/api/v1/restaurants/:restaurantId/dishes', ...authMiddleware, dishRoutes);
